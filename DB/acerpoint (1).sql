...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2015 at 02:58 PM
...
(3, '2015-06-19', 'Mie Sedap Goreng', 2500, 3, 7500),
(4, '2015-06-19', 'ciki-ciki', 500, 5, 2500);
...
(3, 'toko elecktronik jaya', 'sumbersari, jember', '085730420852');
...
(5, 'Alin Janahiq', 'Jember', '087755765081', 'allyn.am96@gmail.com', 'alin', '8df03bca3f48d310f74fe6092af08c95', 'admin');
...
ALTER TABLE `pemasukan`
  ADD CONSTRAINT `pemasukan_ibfk_1` FOREIGN KEY (`id_suplier`) REFERENCES `suplier` (`id_suplier`),
  ADD CONSTRAINT `pemasukan_ibfk_2` FOREIGN KEY (`kode_brg`) REFERENCES `produk` (`kode_brg`);
