...
<table cellpadding="10" cellspacing="0" border="0">
	<tr bgcolor="#cccccc">
	<th colspan="7"><font size="6">DATA PRODUK ONLINEPOS ACER COLECTION</font></th>
	</tr>
<tr bgcolor="red">
	<th>Kode Barang</th>
	<th>Nama Barang</th>
	...
	while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
		...
		<tr bgcolor="#ffffff">
			...
			<?php	
				echo "<td><a href='produk_delete.php?kode_brg=$row[kode_brg]'>Delete</a></td>";
				echo "<td><a href='produk_edit.php?kode_brg=$row[kode_brg]'>edit</a></td>";
				?>
			</tr>
		<?php
	}
